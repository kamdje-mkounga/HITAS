        ...
        <main className="welcome-page">
            ...
            <div className="welcome-background">
                ...
                <video
                    ref={videoRef}
                    src={globalVideo}
                    className={`welcome-video ${videoVisible
                        ? 'video-visible'
                        : 'video-hidden'
                        }`}
                    autoPlay
            ...
            <section className="welcome-content">
                ...
                <div className="content-inner">
                    ...
                    <div className="eyebrow">
                        ...
                        <span>
                            COMMUNAUTÉ INTERNATIONALE HITAS
                        </span>
                    ...
                    <p className="welcome-description">
                        ...
                        Accédez à votre espace d’échange,
                        suivez l’actualité des campus à travers
                        le monde et connectez-vous avec vos pairs.
                            ...
                            {countries.map((country) => {
                                ...
                                return (
                                    ...
                                    <button
                                        ...
                                        className={`country-button ${isActive
                                            ? 'country-active'
                                            : ''
                                            }`}
                                    >
            ...
            <footer className="welcome-footer">
                ...
                <span>
                    Connecter les étudiants. Partout.
                </span>
                ...
                .welcome-overlay {
                    ...
                    background:
                        ...
                        linear-gradient(
                            ...
                            rgba(4, 7, 20, 0.28) 38%,
                            rgba(4, 7, 20, 0.40) 60%,
                            rgba(4, 7, 20, 0.88) 100%
                        ),

                        /* Horizontal cinematic control */
                        linear-gradient(
                            to right,
                            rgba(4, 7, 20, 0.62),
                            rgba(4, 7, 20, 0.08) 50%,
