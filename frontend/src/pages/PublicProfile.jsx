...
const PublicProfile = () => {
  ...
  const getFileName = (rawMedia) => {
    ...
    if (typeof rawMedia === 'object' && rawMedia !== null) {
      if (rawMedia.originalName) {
        return rawMedia.originalName;
      }
    ...
    return (
      decodeURIComponent(fullName.split('?')[0]) ||
      'Fichier joint'
    );
  };
  ...
  if (loading) {
    return (
      <>
        ...
        <div className="bg-[#030014] min-h-screen pt-24 flex items-center justify-center">
  ...
  if (error || !userProfile) {
    return (
      <>
        ...
        <div className="w-full min-h-screen bg-[#030014] text-zinc-100 flex items-center justify-center p-4 pt-24">
          <div className="bg-[#0b081e]/90 backdrop-blur-xl p-8 rounded-3xl border border-indigo-900/60 text-center max-w-sm w-full shadow-2xl">
            ...
            <p className="text-red-300 text-xs mb-6 font-medium">
              {error || "Profil introuvable."}
            </p>

            <button
              onClick={() => navigate(-1)}
              className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-2.5 px-4 rounded-xl text-xs transition-all shadow-lg shadow-indigo-600/20"
            >
              Retour
            </button>
  ...
  const renderSkills = () => {
    ...
    return skillsArray
      ...
      .map((skill, index) => (
        <span
          key={index}
          className="bg-indigo-500/10 text-indigo-300 border border-indigo-500/20 px-3 py-1.5 rounded-xl text-xs font-medium tracking-wide transition-all hover:bg-indigo-500/20 flex items-center gap-1.5 w-fit"
        >
  ...
  return (
    <>
      ...
      <div
        className="w-full min-h-screen bg-[#030014] text-zinc-100 antialiased pt-28 pb-10 relative overflow-x-hidden selection:bg-indigo-500 selection:text-white"
        style={{
          backgroundImage: `
            linear-gradient(
              to bottom,
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          ...
          <button
            onClick={() => navigate(-1)}
            className="mb-6 group text-xs text-zinc-400 hover:text-white flex items-center gap-2 transition-all bg-[#0b081e]/60 backdrop-blur-md border border-indigo-900/40 px-3.5 py-2 rounded-xl w-fit"
          >
          ...
          <div className="bg-[#0b081e]/80 backdrop-blur-2xl p-8 rounded-3xl border border-indigo-500/20 shadow-2xl mb-8 flex flex-col sm:flex-row items-center gap-6 relative overflow-hidden">
            ...
            <div className="text-center sm:text-left flex-1 min-w-0">
              ...
              <p className="text-indigo-400 text-xs font-semibold tracking-wide mb-1 flex items-center justify-center sm:justify-start gap-1.5">
                ...
                {userProfile.specialty || 'Informatique'}

                <span className="text-indigo-600">•</span>

                Promo {userProfile.promotion || 'Non renseignée'}
              </p>
              ...
              {(userProfile.jobTitle ||
                ...
                <p className="text-zinc-300 text-xs font-medium mb-4 flex items-center justify-center sm:justify-start gap-1.5 bg-[#030014]/50 border border-indigo-900/30 px-3 py-1.5 rounded-xl w-fit mx-auto sm:mx-0">
                  ...
                  {userProfile.jobTitle || 'Poste'}

                  {userProfile.currentCompany
                    ? ` chez ${userProfile.currentCompany}`
                    : ''}
          ...
          <div className="flex border-b border-indigo-900/40 mb-8 gap-8 text-xs font-bold tracking-wider overflow-x-auto scrollbar-none">
            ...
            <button
              ...
              className={`pb-4 flex items-center gap-2 transition-all cursor-pointer whitespace-nowrap relative ${
                activeTab === 'compte'
                  ? 'text-indigo-400'
            ...
            >
              ...
              {activeTab === 'compte' && (
                <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-indigo-500 shadow-[0_0_12px_rgba(99,102,241,0.8)]"></div>
              )}
            </button>
              ...
              <div className="bg-[#0b081e]/80 backdrop-blur-2xl p-6 sm:p-8 rounded-3xl border border-indigo-500/20 shadow-xl overflow-hidden">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs mb-4">
                  ...
                  <div className="bg-[#030014]/70 p-4 rounded-2xl border border-indigo-900/40 hover:border-indigo-500/30 transition-all">
                    <span className="text-zinc-500 block mb-1 uppercase text-[10px] font-bold tracking-wider">
                      Prénom
                    </span>

                    <span className="text-zinc-100 font-semibold text-sm break-words">
                  ...
                  <div className="bg-[#030014]/70 p-4 rounded-2xl border border-indigo-900/40 hover:border-indigo-500/30 transition-all">
                    ...
                    <span className="text-zinc-100 font-semibold text-sm break-words">
                      {userProfile.status || 'Non renseigné'}
                    </span>
                  </div>
                  ...
                  <div className="bg-[#030014]/70 p-4 rounded-2xl border border-indigo-900/40 hover:border-indigo-500/30 transition-all">
                    ...
                    <span className="text-zinc-100 font-semibold text-sm break-words">
                      {userProfile.degreeLevel || 'Non renseigné'}
                    </span>
                  </div>
                ...
                <div className="bg-[#030014]/70 p-4 sm:p-5 rounded-2xl border border-indigo-900/40 text-xs mb-4">
                  ...
                  <span className="text-zinc-500 block mb-2 uppercase text-[10px] font-bold tracking-wider">
                    Biographie
                  </span>

                  <p className="text-zinc-200 leading-relaxed text-sm whitespace-pre-line break-words">
                    {userProfile.bio ||
                      "Cet étudiant n'a pas encore rédigé de biographie."}
                  </p>
                ...
                <div className="bg-[#030014]/70 p-4 sm:p-5 rounded-2xl border border-indigo-900/40 text-xs">
                  ...
                  <span className="text-zinc-500 block mb-3 uppercase text-[10px] font-bold tracking-wider">
                    Compétences
                  </span>
              ...
              {userProjects.length === 0 ? (
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  {userProjects.map((project) => {
                    ...
                    const mediaCount = Array.isArray(potentialMedia)
                      ? potentialMedia.length
                      : potentialMedia
                        ? 1
                        : 0;
                        ...
                        <div className="flex-1 flex flex-col justify-between min-w-0">
                          ...
                          <div>
                            ...
                            <div className="flex justify-between items-start gap-3">
                              ...
                              <h3 className="font-black text-base sm:text-lg text-white group-hover:text-indigo-400 transition-colors uppercase tracking-wide break-words">
                                {project.title}
                              </h3>

                              <span className="text-[11px] text-indigo-300 bg-indigo-500/10 border border-indigo-500/20 px-3 py-1 rounded-xl font-bold whitespace-nowrap shadow-sm flex items-center gap-1">
                            ...
                            <p className="text-zinc-400 text-xs leading-relaxed mt-2.5 line-clamp-2 break-words">
                              {project.description}
                            </p>
        ...
        {selectedProject &&
          (() => {
            ...
            const fullMediaUrl =
              formatMediaUrl(rawMedia);

            const fileName =
              getFileName(rawMedia);

            const mediaStringUrl =
            ...
            return (
              ...
              >
                ...
                <div
                  className="bg-[#0b081e] border border-indigo-500/30 w-full max-w-2xl rounded-3xl max-h-[90vh] overflow-y-auto flex flex-col shadow-2xl"
                ...
                >
                  ...
                  <div className="p-6 border-b border-indigo-900/60 flex justify-between items-center bg-[#0b081e]/90 sticky top-0 z-20 backdrop-blur-xl">
                    ...
                    <div className="min-w-0 pr-4">
                      ...
                      <span className="text-[10px] bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 px-2.5 py-1 rounded-lg font-bold uppercase tracking-wider">
                        Détails du projet
                      </span>

                      <h2 className="text-lg sm:text-xl font-black text-white mt-1.5 uppercase tracking-wide break-words">
                    ...
                    <button
                      onClick={() => setSelectedProject(null)}
                      className="w-9 h-9 rounded-2xl bg-[#030014] border border-indigo-900 text-zinc-400 hover:text-white flex items-center justify-center text-sm transition-colors flex-shrink-0 shadow-md"
                    >
                      <X className="w-4 h-4" />
                    </button>
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div>
                      ...
                      <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-2.5">
                      ...
                      {fullMediaUrl ? (
                        ...
                        <div className="bg-[#030014]/70 border border-indigo-900/50 rounded-2xl p-4 space-y-4">
                          ...
                          <a
                            ...
                            className="w-full bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-indigo-600/20"
                          >
                        ...
                        <div className="bg-[#030014]/70 border border-indigo-900/50 rounded-2xl p-6 text-center text-xs text-zinc-500 italic">
                          Aucun fichier joint.
                        </div>
                  ...
                  <div className="p-4 border-t border-indigo-900/60 bg-[#0b081e]/90 text-right backdrop-blur-xl rounded-b-3xl">
                    ...
                    <button
                      onClick={() => setSelectedProject(null)}
                      className="bg-zinc-100 text-zinc-950 text-xs font-bold px-5 py-2.5 rounded-xl hover:bg-zinc-200 transition-all shadow-md"
                    >
                      Fermer
                    </button>
