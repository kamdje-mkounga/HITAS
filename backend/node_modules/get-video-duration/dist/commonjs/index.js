...
var getFFprobeWrappedExecution = function (input, ffprobePath) {
    ...
    if (typeof input === "string") {
        return (0, execa_1.execa)(overridenPath, __spreadArray(__spreadArray([], params, true), [input], false));
    }
    if ((0, is_stream_1.isStream)(input)) {
        return (0, execa_1.execa)(overridenPath, __spreadArray(__spreadArray([], params, true), ["-i", "pipe:0"], false), {
            reject: false,
            input: input,
        });
    }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                matched = stdout === null || stdout === void 0 ? void 0 : stdout.match(/duration="?(\d*\.\d*)"?/);
                if (matched === null || matched === void 0 ? void 0 : matched[1])
                    return [2 /*return*/, parseFloat(matched === null || matched === void 0 ? void 0 : matched[1])];
